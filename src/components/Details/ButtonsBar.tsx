    ...
    return (
        <div className={`mt-[20px] w-[100%] bg-[#FFFFFF] rounded-[8px] p-[24px_32px_24px_32px] flex items-center justify-between shadow-[0_10px_10px_-10px_rgba(72,84,159,0.1)] ${toggle ? "bg-[#1E2139]!" : undefined}`}>
            ...
            <div className="flex gap-[8px]">
                <button className={`w-[73px] h-[48px] rounded-[24px] bg-[#F9FAFE] flex items-center justify-center ${P2} text-[#7E88C3]! ${toggle? "bg-[#252945]!" : undefined} font-[700] cursor-pointer`} onClick={() => {
                    setShowForm(true)
                    setEditForm(true)
                }}>Edit</button>
